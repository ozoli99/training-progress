...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="relative min-h-dvh overflow-hidden bg-background text-foreground">
        ...
        <main className="mx-auto grid max-w-2xl place-items-center px-4 py-16">
          <div className="w-full rounded-2xl border bg-card/70 backdrop-blur supports-[backdrop-filter]:bg-card/50 shadow-sm">
            <div className="p-6 sm:p-8 text-center">
              ...
              <div className="mt-4 inline-flex w-full items-center gap-2 rounded-md border bg-muted/50 px-3 py-2 text-xs text-muted-foreground">
              ...
              {isDev && (
                <details className="mt-6 w-full rounded-md border bg-muted/40 p-4 text-left">
                  ...
                  <div className="mt-3 overflow-auto rounded-md bg-background p-3 text-left text-xs leading-relaxed">
          ...
          <p className="mt-6 text-center text-xs text-muted-foreground">
            If the problem persists, include the Error ID when contacting
            support.
          </p>
        </main>
      </body>
